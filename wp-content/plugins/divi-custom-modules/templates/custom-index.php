	...
	<div id="main-content">
		<div class="container">
			<div id="content-area" class="clearfix">
				...
				echo '</div>';
				?>
				<span class="blog-cat-top"><?php $categories = get_the_category();
					if ( ! empty( $categories ) ) {
						echo '<a href="' . esc_url( get_category_link( $categories[0]->term_id ) ) . '"><i class="fa fa-tags"></i> ' . esc_html( $categories[0]->name ) . '</a>';
					} ?>
							</span>
