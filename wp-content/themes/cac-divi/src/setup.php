...
add_action('after_setup_theme', function () {
    ...
    register_nav_menus([
        'primary_navigation' => __('Primary Navigation', 'sage'),
				...
				'micro_navigation' => __('Micro Navigation', 'sage')
    ]);
...
add_action('after_setup_theme', function () {
    ...
    /**
     * Create @get_sset() Blade directive
     */
    sage('blade')->compiler()->directive('get_asset', function ($asset) {
        return '<? $asset = App\\asset_path(\''.trim($asset, '\'"').'\'); ?>';
    });
});
